// modified from: https://github.com/kotsoft/particle_based_viscoelastic_fluid/
...
class Material {
  constructor(name, restDensity, stiffness, nearStiffness, kernelRadius) {
    ...
    this.minDistRatio = 0.0; // prevents the springs from getting too short
...
export { Simulator, Material, Particle, Spring }